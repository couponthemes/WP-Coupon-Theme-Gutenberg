    ...
    class WPCoupon_Theme_Options_Config {
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'menu_title'         => esc_html__( 'Theme Options', 'wp-coupon' ),
                ...
                'footer_credit'     => 'Develop by <a href="http://couponthemes.net/">CouponThemes.com</a>',
        ...
        public function setSections() {
            ...
            /*--------------------------------------------------------*/
            $this->sections[] = array(
                'title'  => esc_html__( 'Colors', 'wp-coupon' ),
                'desc'   => '',
                'icon'   => 'el-icon-idea',
                'submenu' => true,
                'fields' => array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type'     => 'switch',
                        'title'    => esc_html__( 'Enable Coupon Submit', 'wp-coupon' ),
                        'subtitle' => esc_html__( 'Enable the coupon submit button in store page.', 'wp-coupon' ),
                        'default'  => true,
                    ),
            ...
            /*--------------------------------------------------------*/
            $this->sections[] = array(
                'title'  => esc_html__( 'Email Templates', 'wp-coupon' ),
                'desc'   => '',
